...
HD_PWD='C:/Users/yeha1518/dev/hdl/xilinx_fifo_test/xilinx_fifo_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_test_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_test_top.tcl
