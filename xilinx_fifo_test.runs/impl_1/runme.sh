...
HD_PWD='C:/Users/yeha1518/dev/hdl/xilinx_fifo_test/xilinx_fifo_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_test_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fifo_test_top.tcl -notrace
